      ...
      <div class="card-body">
          ...
          <div class=" d-flex align-items-center flex-column">
            ...
            <div class="user-info text-center">
              @auth
                ...
                <span class="badge bg-label-secondary">{{ $user->roles->first()->name }}</span>
        ...
        <div class="info-container">
          ...
          <div class="d-flex justify-content-center pt-3">
            ...
            @if($user->status == 'active')
              <button class="btn btn-warning" onclick="suspendUser({{ $user->id }})">Suspender</button>
            @elseif($user->status == 'inactive')
              <button class="btn btn-success" onclick="activateUser({{ $user->id }})">Activar</button>
            @endif
        </div>
      </div>
    </div>
